    ...
    return (
        <footer className="footer items-center p-4 text-neutral-content fixed bottom-0 z-50">
            <aside className="items-center grid-flow-col gap-3">
                ...
                <p className="leading-normal tracking-wide font-medium text-md">Crafted by Team 174 - VITB '24 Capstone Project</p>
            </aside>
            <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                <a href="https://github.com/kart781/Frontend-SSPSDLFAM" target="_blank">
